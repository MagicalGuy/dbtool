@echo off
rem ============================================================
rem  Build DbGuiTool  (Qt 5.13.0 MSVC2015 64-bit, Release)
...
set "BUILD=E:\QT course\C++QT5\01\build-dbtool-Desktop_Qt_5_13_0_MSVC2015_64bit-Release"
...
"%QMAKE%" "%SRC%" -spec win32-msvc "CONFIG+=release"
if errorlevel 1 exit /b 1
